...
<div>
                    ...
                    <div class="table-responsive m-t-40">
                        <table class="table stylish-table">
                            ...
                            <tbody>
                                ...
                                <tr class="active">
                                    <td><span class="round"><img src="{{url('/')}}/assets//images/users/2.jpg" alt="user" width="50" /></span></td>
                                    <td>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-responsive" src="{{url('/')}}/assets/images/big/img1.jpg" alt="Card">
                <div class="card-block">
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-responsive" src="{{url('/')}}/assets/images/big/img2.jpg" alt="Card">
                <div class="card-block">
                    <ul class="list-inline font-14">
                        <li class="p-l-0">20 May 2016</li>
                        <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
        ...
        <div class="col-lg-4">
            <div class="card">
                <img class="card-img-top img-responsive" src="{{url('/')}}/assets/images/big/img4.jpg" alt="Card">
                <div class="card-block">
                    <ul class="list-inline font-14">
                        <li class="p-l-0">20 May 2016</li>
                        <li><a href="javascript:void(0)" class="link">3 Comment</a></li>
...
<script src="{{url('/')}}/assets/js/flot-data.js"></script>
@endsection