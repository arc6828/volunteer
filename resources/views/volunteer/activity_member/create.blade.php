	...
	<div class="col-md-6">
		<div class="card">
		    <div class="card-block">
    			...
    			<form class="form-material" action="{{ url('/') }}/activity/{{ $activity_id }}/member" method="POST">
					{{ csrf_field() }}
					{{ method_field('POST') }}
					<div class="form-group">
	                    <label class="col-md-12">รหัส student</label>
	                    <div class="col-md-12">
							<input type="number" name="serial" class="form-control form-control-line" placeholder="ใส่หัส student" >
	                    </div>
	                </div>
	                <div class="form-group">
                        <div class="col-sm-12">
