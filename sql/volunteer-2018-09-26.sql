...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 25, 2018 at 07:25 PM
...
(3, 'อบรมการสร้างเว็บไซต์ด้วย Wordpress', '2018-04-20', '2018-09-20', '06:00:00', '19:00:00', 'อาคาร 75 ปี', 7, 1, 2, 1);
...
(1, 'วิทยาการคอมพิวเตอร์', 3),
(2, 'เทคโนโลยีสาระสนเทศ', 3);
...
(1, '58122420101', 'สุรยวัฒน์', 'ปริญาตรี', 1),
(2, '58122420102', 'กล้านรงค์', 'ปริญาตรี', 1),
(3, '58122420103', 'ชัชวาล', 'ปริญาตรี', 1),
...
(4, 'Chavalit Koweerawong', 'chavalit.kow@gmail.com', '$2y$10$m8kwLIT9KGR/A55MvXh3lufUhTt2ENCiDP2nzFJvBsoaX/n9A1ro.', 'UcBSyqNxhLNnXSwSZ3vgYw2n9irMToFoQyqRrAl4UCm2108TDISyPvFVBLc0', '2018-07-19 02:20:07', '2018-07-19 02:20:07', 'admin_dsd');
...
--
ALTER TABLE `activity_member`
  MODIFY `activity_member_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `faculty`
--
ALTER TABLE `faculty`
  MODIFY `faculty_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส faculty', AUTO_INCREMENT=4;
...
--
ALTER TABLE `student`
  MODIFY `serial` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส student', AUTO_INCREMENT=7;
